...
#define CONNECTION_STATE_UNKNOWN_LICENSE    9
#define CONNECTION_STATE_SLEEP              10
#define CONNECTION_STATE_DEVICE_MAX_SESSION 11
#define CONNECTION_STATE_POOR_NETWORKSIGNAL 12
#define CONNECTION_STATE_WRONG_AUTHKEY      13
#define CONNECTION_STATE_VIDEOPAUSE         14
...
#define RECV_VIDEO_BUFFER_SIZE              1024*1024
