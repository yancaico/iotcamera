...
*
* \details Client can connect to IOTC device which DebugTool is turn on and collect sdk information in LAN mode.
*
...
*            - #IOTC_ER_TIMEOUT Return this code when device is offline, device not call IOTC_DebugTool_Initialize(), wrong UID, wrong password.
*
* \attention (1) This API is a blocking function.
*
**/
P2PAPI_API_DEPRECATED int32_t IOTC_Get_DebugTool_Info(const char *uid, const char *pwd, char *buf, int32_t buf_size, int32_t *data_size, int32_t timeout_sec);
